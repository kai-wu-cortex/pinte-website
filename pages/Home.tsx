...
const Home: React.FC = () => {
  ...
  return (
    <main className="min-h-screen">
      ...
      <SEOMeta
        title={lang === 'cn' ? '品特PINTE - 高端烫金膜专家 | 中国东莞烫金膜生成厂家' : 'PINTE - Premium Hot Stamping Foil Manufacturer | China Dongguan'}
        description={lang === 'cn'
          ? '主营烫金箔、烫金膜、冷烫箔、电化铝、颜料箔、全息烫金箔，供应越南、东南亚、马来西亚、泰国、印尼等市场。'
          : 'PINTE is a leading manufacturer of high-end hot stamping foils based in Dongguan China. We supply hot stamping foil, cold foil, digital foil, pigment foil, holographic foil to Vietnam, Southeast Asia, Malaysia, Thailand, Indonesia and global markets.'
        }
        keywords={lang === 'cn'
          ? ['烫金箔', '烫金膜', '电化铝', '冷烫箔', '颜料箔', '全息烫金箔', '烫金', '包装印刷', '东莞', '中国', '东南亚', '越南', '东莞烫金膜', '塑胶烫金膜', '颜料箔', '化妆品烫印箔', '化妆品烫金', '纸张烫印', '纸张烫金加工', '东莞高端烫金箔生产厂家', '中国冷烫箔供应商', '东南亚烫金膜批发', '越南电化铝定制', '全息烫金箔厂家直销', '颜料箔生产厂家', '包装印刷用烫金箔', '塑胶皮革烫金膜', '数码冷烫', '数码冷烫烫金膜', '丝印冷烫', '丝印冷烫烫金膜', '数码印刷烫金箔', '出口东南亚烫金箔', '品特PINTE烫金箔']
