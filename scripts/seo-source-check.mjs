...
function validationIssueField(issue) {
  const fields = {
    ...
    'missing-source-registry-record': 'topics.json topic_id',
    'registry-source-mismatch': issue.field || 'topics.json parity',
    'published-registry-source-pair': 'topics.json status/lang',
    'reviewed-registry-source-required': 'topics.json status',
