...
export const LEGACY_GUIDE_CLUSTERS = {
...
const clusterIdSet = new Set(GUIDE_CLUSTER_IDS);
const GENERAL_CLUSTER_ID = 'fundamentals-terminology';
export const resolveGuideClusterId = (cluster) => {
    if (!cluster || cluster === 'general')
        return GENERAL_CLUSTER_ID;
    return clusterIdSet.has(cluster) ? cluster : GENERAL_CLUSTER_ID;
};
