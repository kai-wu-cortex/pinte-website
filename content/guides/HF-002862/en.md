...
title: >-
  Polyethylene (PE) Corona or plasma treatment Narrow-web cold foil transfer Continuous holographic
  pattern: foil selection guide
description: >-
  Covers Polyethylene (PE) Narrow-web cold foil transfer projects, including Corona or plasma
...
hero_image: /images/guides/library/hot-stamping-foil-guide-photo-004.avif
hero_alt: Polyethylene (PE) Narrow-web cold foil transfer hot stamping foil application reference
answer: >-
  For Polyethylene (PE), foil selection should match Corona or plasma treatment, Narrow-web cold
...
This guide is for Polyethylene (PE) foil projects in Cosmetics and personal care, with attention to Corona or plasma treatment, Narrow-web cold foil transfer, and Continuous holographic pattern. Do not brief the supplier with only “bright gold,” “matte gold,” or “holographic.” The useful brief connects substrate construction, surface treatment, artwork difficulty, machine route, and finished-package testing. Final settings require sampling on the actual substrate, machine, artwork/design, and speed before bulk production.

## Specific scope

The practical buyer question is: Which foil selection checks matter for continuous holographic pattern on polyethylene (PE) under Corona or plasma treatment / Narrow-web cold foil transfer / Paper and film label cold transfer / Cosmetics and personal care / Continuous holographic pattern?

The substrate is Polyethylene (PE), the surface is Corona or plasma treatment, the process is Narrow-web cold foil transfer, and the application is Cosmetics and personal care. Artwork attention: Continuous holographic pattern.

The scope is: Narrows grade selection to Continuous holographic pattern, Polyethylene (PE), Corona or plasma treatment, and Narrow-web cold foil transfer. Useful working terms include Selection, Continuous Holographic Pattern, Cosmetics Personal Care, Label Cold Transfer. Reference context includes Astm D5264 98r19 Abrasion, Heidelberg Foilstar, Inx Hot Cold Foil Guide, Foilco D4 Grade Guide, Kurz Cold Transfer. These details help buyers, designers, press operators, and quality teams discuss the same production risk; they do not replace job-specific sampling.

## Application context and risk

- Typical substrate: Polyethylene (PE)
...
Polyethylene is often used for flexible bottles, tubes, films, and lightweight packaging parts. Its surface-energy decay, soft recovery, and scratch behavior differ from PP and paper. PE foil testing should include bending, squeezing, shipping abrasion, and hand-contact contamination, not only the brightness immediately after transfer.

PE projects should also track material batch and pretreatment window. Even when the color looks identical, resin formulation, slip additives, recycled content, and surface aging can change cold-foil adhesive wetting and final adhesion.
