...
primary_keyword: 薄膜标签面材电晕或等离子处理表面干擦耐磨测试与掉粉、碎金或边缘碎屑验收指南
secondary_keywords:
  - Testing
  - Dry Rub Abrasion
...
这篇指南面向包装应用中的薄膜标签面材烫金膜项目，重点判断电晕或等离子处理表面、窄幅冷烫和掉粉、碎金或边缘碎屑之间的关系。采购时不能只说“亮金”“哑金”或“镭射”，而要把底材结构、表面处理、图稿难度、设备路线和成品测试一起交给供应商判断。最终设置必须通过实际承印物、机台、图稿/设计和速度条件下的打样确认。

## 本文具体解决的问题

实际读者通常会问：薄膜标签面材烫金确认何时使用干擦或耐磨对比（适用条件：电晕或等离子处理 / 窄幅冷烫 / 纸质和薄膜标签冷烫 / 掉粉、碎金或边缘碎屑 / 干擦或耐磨对比）？

底材是薄膜标签面材，表面是电晕或等离子处理表面，工艺是窄幅冷烫，应用是实际包装应用。测试方法是干擦耐磨测试。故障表现是掉粉、碎金或边缘碎屑。

这篇文章的边界是：Connects one acceptance method to the exact substrate, surface, process, and failure symptom it can check. 相关判断词包括 Testing、Dry Rub Abrasion、Foil Flaking Dusting。参考资料方向包括 Astm D3359 23 Tape Test、Astm D5264 98r19 Abrasion、Iso 2409 2020 Cross Cut、Iso 2836 2021 Print Resistance、Inx Hot Cold Foil Guide。这些信息用于帮助采购、设计、机长和质检用同一套语言讨论问题，不用于替代真实订单打样。
