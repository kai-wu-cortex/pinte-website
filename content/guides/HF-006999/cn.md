...
hero_alt: ''
answer: >-
  用于折叠纸盒纸板选择烫金压凸还是平压平热烫（原始未涂布表面时，应按底材结构、表面处理、工艺路线、图稿细节和成品耐性要求选择烫金膜。最终设置必须通过实际承印物、机台、图稿/设计和速度条件下的打样确认。
faqs:
...
本页写作和打样应围绕这些标签展开：Comparison；Hot Stamping Embossing；Hot Stamping Flatbed；Board Folding Carton。本页计划参考的资料组包括：fsea-foil-cheat-sheet、gietz-hot-foil-machines、inx-hot-cold-foil-guide、kurz-cold-transfer、kurz-decoration-processes。落到采购动作上，询价不能只写金色、银色、镭射或颜料效果，而要写清折叠纸盒纸板选择烫金压凸还是平压平热烫（原始未涂布表面、烫金压凸、标准纸张盒彩热烫），并说明Combined foil stamping and embossing vs Flatbed or platen hot stamping属于外观问题、耐性问题还是机台参数问题。

比较供应商时，建议让每一家按照同一张订单卡报价。订单卡至少包括材料结构、卷料或片材尺寸、机台路线、颜色目标、图稿难度、打样数量、包装运输条件和复购要求。这样可以避免一个供应商按普通装饰膜报价，而实际订单却需要耐性型或套准型膜材。

## 建议询价写法

可以把询价写成更具体的一句话：“折叠纸盒纸板选择烫金压凸还是平压平热烫（原始未涂布表面 / 烫金压凸 / 标准纸张盒彩热烫） 折叠纸盒纸板应选择烫金压凸还是平压平热烫（适用条件：原始未涂布表面 / 烫金压凸 / 标准纸张盒彩热烫）？ Compares two compatible processes for the same Folding carton board and surface condition instead of describing foil transfer in general. 主题集群 process-comparison 意图 comparison 批次位置 17”。
...
不能。需要同时确认折叠纸盒纸板选择烫金压凸还是平压平热烫（原始未涂布表面、烫金压凸、标准纸张盒彩热烫）、图稿细节和生产速度，再决定是否适合批量采购。
